...
/*
 * Define a Configuration structure for a USART peripheral
...
/*
 * Define the Handle Structure for a USART peripheral
 */

typedef struct {

	// First step is to define a pointer to hold the base address of the USART peripheral
...
/*
 * @USART application event marcos
 */
